...
function EditListing() {
  ...
  }, [isMounted, formData, navigate, auth])
    ...
    <div className='profile'>
      ...
      <main>
        ...
        <div className="formButtons">
          ...
          <button className={!parking && parking !== null ? 'formButtonActive' : 'formButton'} type='button' id='parking' value={false} onClick={onMutate} min='1' max='50'>No</button>
        </div>
        ...
        <div className="formButtons">
          ...
          <button className={!furnished && furnished !== null ? 'formButtonActive' : 'formButton'} type='button' id='furnished' value={false} onClick={onMutate} min='1' max='50'>No</button>
        </div>

        <label htmlFor="" className="formLabel">Address</label>
        <textarea type='text' id='address' value={address} onChange={onMutate} className="formInputAddress" required />
        ...
        <div className="formButtons">
          <button className={offer ? 'formButtonActive' : 'formButton'} type='button' id='offer' value={true} onClick={onMutate} min='1' max='50'>Yes</button>
          <button className={!offer && offer !== null ? 'formButtonActive' : 'formButton'} type='button' id='offer' value={false} onClick={onMutate} min='1' max='50'>No</button>
        </div>
